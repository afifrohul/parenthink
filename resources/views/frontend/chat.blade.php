...
<div class="container mx-auto shadow-lg rounded-lg ">
    ...
    <div class="px-5 py-5 flex justify-between items-center bg-white border-b-2">
      <div class="font-semibold text-2xl">
        <a href="#">
          ...
          <p class="text-amber-400 text-xl">Forum and Consule</p> 
        </a>
      </div>
      <div class="w-1/2">
        <input
    ...
    <div class="flex flex-row justify-between bg-white">
      ...
      <div class="flex flex-col w-2/5 border-r-2 overflow-y-auto">
        ...
        <div
          class="flex flex-row py-4 px-2 items-center border-b-2 border-l-4 border-amber-400"
        >
          <div class="w-1/4">
            <img
        ...
        <div class="flex flex-row py-4 px-2 items-center border-b-2">
          ...
          <div class="w-full">
            <div class="text-lg font-semibold">Parent Indonesia</div>
            <span class="text-gray-500">Nia : some one can fix this</span>
          </div>
        </div>
        <div class="flex flex-row py-4 px-2 items-center border-b-2">
          <div class="w-1/4">
          ...
          <div class="w-full">
            <div class="text-lg font-semibold">Parenthink</div>
            <span class="text-gray-500">Heni : some one can fix this</span>
          </div>
        </div>
        <div class="flex flex-row py-4 px-2 items-center border-b-2">
          <div class="w-1/4">
          ...
          <div class="w-full">
            <div class="text-lg font-semibold">Parent Hope</div>
        ...
        {{-- <div class="flex flex-row py-4 px-2 items-center border-b-2">
          ...
          <div class="w-full">
            <div class="text-lg font-semibold">Lorem Ipsum</div>
            <span class="text-gray-500">Evan : some one can fix this</span>
          </div>
        </div> --}}
        <!-- end user list -->
      ...
      <div class="w-full px-5 flex flex-col justify-between">
        <div class="flex flex-col mt-5">
          <div class="flex justify-end mb-4">
            <div
              class="mr-2 py-3 px-4 bg-amber-400 rounded-bl-3xl rounded-tl-3xl rounded-tr-xl text-white"
            >
          ...
          <div class="flex justify-end mb-4">
            <div>
              ...
              <div
                class="mt-4 mr-2 py-3 px-4 bg-amber-400 rounded-bl-3xl rounded-tl-3xl rounded-tr-xl text-white"
              >
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Debitis, reiciendis!
              </div>
